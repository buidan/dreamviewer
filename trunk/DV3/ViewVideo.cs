    ...
    public partial class ViewVideo : Form
    {
        ...
        private void GetEPG()
        {
            try
            {
                ...
                int last = 0;
                string name = "";
                XmlTextReader reader = new XmlTextReader("http://127.0.0.1/videoteka/servis.php");
                while (reader.Read())
                {
                ...
                {
                    Client.DownloadFile("http://127.0.0.1/videoteka/cover/" + v.getID() + ".jpg", "cache\\" + v.getID() + ".jpg");
                }
            }
            catch (Exception e)
            {
       ...
       /*     if (info_Recording.Text == "R")
        ...
        private void flowOK()
        {
            if (chan_menu.Visible || oc.Visible)
            {
                ...
                OpenStream("http://127.0.0.1/videoteka/movie/" + loc +".film");
            }
        }
